...
3. Installieren Sie ESPHome [auf Ihrem Computer](https://esphome.io/). ESPHome ist eine Open-Source-Firmware, die es ermöglicht, ESP8266- und ESP32-Mikrocontroller als Smart-Home-Geräte einzurichten.
